...
public class SavedTab extends ScreenBase {
    ...
    private static final By DESCRIPTION_FIELD = MobileBy.xpath("(.//*[@resource-id='android:id/content']//*[@resource-id='org.wikipedia.alpha:id/text_input'])[2]");
    ...
    private static final String LIST_BY_NAME = ".//*[@resource-id='android:id/content' and @text='%s']";
    ...
    public void typeName(String name) {
        element(NAME_FIELD).sendKeys(name);
    }

    @Step("Type description {description}")
    public void typeDescription(String description) {
        element(DESCRIPTION_FIELD).sendKeys(description);
    }
    ...
    private void longTapOnList(String name) {
        ...
        action.longPress(element(MobileBy.xpath(String.format(LIST_BY_NAME, name))));
